...
export class CustomerRegistrationComponent implements OnInit, AfterViewInit, OnDestroy, CanComponentDeactivate {
  ...
  canDeactivate(): Observable<boolean> | Promise<boolean> | boolean {
    if (this.customerForm.touched && this.customerForm.dirty && !this.changesSaved) {
      return confirm(this._translate.instant('Do you want to discard the changes ?'));
    } else {
      return true;
    }
  }
